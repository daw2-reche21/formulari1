...
?>
  ...
  <div>
    ...
    <form action="#" method="post"> 
        ...
        <table>
        <br/>
        <h3 align=left>Write whatever about the film</h3>
            <tr>
                <td>Your name:</td>
                <td><input type="text" name="name" required /></td>
            </tr>
                <input type="hidden" name="fecha" value=<?php echo $tiempo=date("Y-m-d");?>/>
                <input type="hidden" name="idpelicula"
                    value=<?php echo $_GET['movie_id']; ?>>
            </tr>
            <tr>
                <td>What do you think about <?php echo $movie_name;?></td>
                <td><textarea name="coment" rows="5" cols="60"></textarea></td>
            </tr>
            <tr>
                <td>Rate from 0 to 5:</td>
                <td><input type="number" name="rate" min="0" max="5" required  /></td>
